...
gui.menu = {
	lua_enable = main:ui(ui.new_checkbox(tab,place,"Enable \aB2ACDDFFaethletic.lua\aFFFFFFB6"),true),
	lua_tab = main:ui(ui.new_combobox(tab,place,"Lua tab",{"Anti-aimbot Bullider","","Visuals","Misc","Configs"}),true),
    clan_tag = main:ui(ui.new_checkbox(tab,place,'\aB2ACDDFFEnable\aFFFFFFB6 Clantag'),true),
    kill_say = main:ui(ui.new_checkbox(tab,place,"\aB2ACDDFFEnable\aFFFFFFB6 Trashtalk"),true),
...
for i = 1, 7 do
    gui.menu.custom[i] = {
        ...
        freestanding = main:ui(ui.new_checkbox("AA", "Anti-aimbot angles", "Freestanding\n" .. var.p_states[i]),true),
...
up_abuse = function()
    ...
    if not ui.get(gui.menu.pitch_up_exploit) then return end
...
watermark = function() -- watermark function
  ...
  local watermark_string = string.format("AETHLETIC [BETA] %s","")
  local watermark_size = { renderer.measure_text(nil,watermark_string) }
  local padding = ui.get(gui.menu.watermark_padding)

  renderer.text(screen_size[1] * 0.46 + 2 + padding,screen_size[1] - screen_size[1] + 1058,155,135,165,200,"nil",0,watermark_string)
...
indicators = function()
    ...
    local scoped = entity.get_prop(me, "m_bIsScoped") == 1
     ...
     if scoped then
        scoped_offset = lerp(scoped_offset,30,globals.frametime() * 15)
    else 
        scoped_offset = lerp(scoped_offset,0,globals.frametime() * 15)
    end
	...
	if ui.get(menu_reference.dt[1]) and ui.get(menu_reference.dt[2]) then
        ...
        indicator_fade_dt = lerp(indicator_fade_dt,10,globals.frametime() * 15)
	...
	elseif not ui.get(menu_reference.dt[1]) or not ui.get(menu_reference.dt[2]) then
		...
		indicator_fade_dt = lerp(indicator_fade_dt,0,globals.frametime() * 15)
	end

	-------------------> OS INDICATOR <-------------------

    new_old_indicator_spacing = lerp(new_old_indicator_spacing,indicator_spacing,globals.frametime() * 15)
	...
	if ui.get(menu_reference.dt[1]) and ui.get(menu_reference.dt[2]) and ui.get(menu_reference.os[1]) and ui.get(menu_reference.os[2]) then
		...
		indicator_fade_hs = lerp(indicator_fade_hs,10,globals.frametime() * 15)
	...
	elseif not ui.get(menu_reference.os[1]) or not ui.get(menu_reference.os[2]) then
        indicator_fade_hs = lerp(indicator_fade_hs,0,globals.frametime() * 15)
...
intro_animation = function()
    ...
    if should_animate == "should_intro" then
        ...
        renderer.text(X / 2, y - 10, 255, 255, 255, alpha,"c",0,"Welcome to AETHLETIC.[BETA]")
...
local kill_say_text = {'я тебя выебал как бабку маута','алё хуеплуша ты почему в ногах','ты думал я тебя не уебну да хуй там плавал','bactrack by africa','Я использую gamesense и aethletic',
'хуй бери и больше не проси а если попросишь то возьми','упал отжался хуесос ебанный'}
...
clantag_array = {"aethletic.gs","aethletic.gs","","","aethletic","aethletic.","aethletic.l","aethletic.gs","aethletic.gs"}
...
hide_controls = function()
    ...
    ui.set_visible(gui.menu.enable_indicators,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.enable_indicators_colors,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals" and ui.get(gui.menu.enable_indicators))
    ...
    ui.set_visible(gui.menu.min_dmg_indicator,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.watermark,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.watermark_padding,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals" and ui.get(gui.menu.watermark))
    --ui.set_visible(gui.menu.min_dmg_slider,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.min_dmg_indicator) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.manual_indicators,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.manual_indicators_style,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals" and ui.get(gui.menu.manual_indicators))
    ui.set_visible(gui.menu.manua_color,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals" and ui.get(gui.menu.manual_indicators))
    ui.set_visible(gui.menu.manual_left,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
    ui.set_visible(gui.menu.manual_right,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
    ui.set_visible(gui.menu.manual_reset,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
   -- ui.set_visible(gui.menu.avatar_esp,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Indicators" and obex_data.build ~= "User")
    ...
    ui.set_visible(gui.menu.anti_knife,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
    ui.set_visible(export,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Configs")
    ui.set_visible(load,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Configs")
    ui.set_visible(gui.menu.stop_intro,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Misc")
    ui.set_visible(gui.menu.defensive_dt_indicator,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
   -- ui.set_visible(gui.menu.LC,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Visuals")
    ui.set_visible(gui.menu.pitch_up_exploit,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")


    ui.set_visible(gui.menu.lua_tab,ui.get(gui.menu.lua_enable) and true or false)

    ui.set_visible(gui.menu.custom[0].player_state,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
    var.active_i = var.state_to_idx[ui.get(gui.menu.custom[0].player_state)]
    for i = 1, 7 do
        ui.set_visible(gui.menu.custom[i].enable, var.active_i == i and i > 0 and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].pitch, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yawbase, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yaw, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yawadd,var.active_i == i and ui.get(gui.menu.custom[var.active_i].yaw) ~= "Off" and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yawadd_right,var.active_i == i and ui.get(gui.menu.custom[var.active_i].yaw) ~= "Off" and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yawjitter, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].yawjitteradd,var.active_i == i and ui.get(gui.menu.custom[var.active_i].yawjitter) ~= "Off" and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].gs_bodyyaw, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].gs_bodyyawadd,var.active_i == i and ui.get(gui.menu.custom[i].gs_bodyyaw) ~= "Off" and ui.get(gui.menu.custom[i].gs_bodyyaw) ~= "Opposite" and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider" and ui.get(gui.menu.custom[i].gs_bodyyaw) ~= "Jitter 2")
        -- ui.set_visible(gui.menu.custom[i].fakeyawlimit, var.active_i == i and ui.get(gui.menu.lua_enable)and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider") 
        -- ui.set_visible(gui.menu.custom[i].fakeyawlimitr, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].freestand_bodyya, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].roll, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].edgeyaw, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].freestanding, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
        ui.set_visible(gui.menu.custom[i].freestanding_key, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot Bullider")
    end
end
